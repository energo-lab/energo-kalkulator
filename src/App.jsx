...
const C = {
  bg: "#eef2f7", card: "#ffffff", cardHover: "#f1f5f9", border: "#dce3ec",
  accent: "#c2740a", accentBright: "#d97d0d", green: "#0f9d6e", red: "#dc2626",
  blue: "#2563eb", purple: "#7c3aed", cyan: "#0891b2", text: "#334155",
  muted: "#64748b", dim: "#94a3b8", white: "#0f172a",
};
